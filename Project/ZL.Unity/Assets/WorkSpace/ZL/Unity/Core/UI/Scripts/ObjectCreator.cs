...
namespace ZL
{
    public static partial class ObjectCreator
    {
            ...
            where TUIBehaviour : UIBehaviour
        {
            ...
            var uiBehaviour = CreateComponent<TUIBehaviour>(name, parent, component);
        ...
        {
            var canvas = CreateComponent<Canvas>(null, parent, typeof(CanvasScaler), typeof(GraphicRaycaster));
        ...
        public static void TryCreateEventSystem()
        {
            ...
            {
                CreateComponent<EventSystem>(null, typeof(StandaloneInputModule));
            }
        }
    }
}