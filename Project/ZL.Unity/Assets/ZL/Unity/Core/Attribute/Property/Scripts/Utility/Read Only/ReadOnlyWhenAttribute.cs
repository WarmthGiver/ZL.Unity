...
namespace ZL.Unity
{
    ...
    public sealed class ReadOnlyWhenAttribute : CustomPropertyAttribute
    {
        private readonly string fieldName;

        private readonly bool targetValue;

        public ReadOnlyWhenAttribute(string fieldName, bool targetValue)
        {
        ...
        protected override void Preset(Drawer drawer)
        {
            ...
            drawer.IsEnabled = property.boolValue != targetValue;
        }
