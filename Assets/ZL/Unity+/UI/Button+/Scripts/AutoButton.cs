...
namespace ZL.UI
{
    ...
    public class AutoButton : NewButton
    {
        ...
        protected override void Reset()
        {
            ...
            Fixed.AnimationUtility.SetKeyRightTangentMode(clickCoolTimeCurve, 0, Fixed.TangentMode.Auto);

            Fixed.AnimationUtility.SetKeyLeftTangentMode(clickCoolTimeCurve, 1, Fixed.TangentMode.Auto);
        }
